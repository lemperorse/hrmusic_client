...
<q-page class="bg-hr  pt-6">
    ...
    <div class="flex flex-col justify-center items-center p-4">
        ...
        <br />
        <div :style="(dark)?`color:white!important;`:``"  class="text-3xl">Heart Rate</div>
        <div :style="(dark)?`color:white!important;`:``"   class="text-xl">Connect Devices</div>
        <br />

        <div class="w-full p-2" v-if="DEVICE">
            <h2 :class="t"  class="text-base">Device is Connectd.</h2>
            <q-item class="rounded-xl border-1 bg-gray-100">
                <div v-if="bleData" class="
              h-20
              w-20
