        ...
        <div class="w-screen flex-1   mr-4    shadow-xl  " :class="(dark)?`bg-black `:`bg-main`">
            ...
            <div class="flex flex-col   p-4  ">
                ...
                <div class="flex flex-col z-10      mt-1 p-4" :class="t"> 
                    <div class="text-xl mb-2" :class="t"><span class="text-yellow-600 font-semibold">Hello</span>, Pongvarid </div>
                        ...
                        <div class="w-full h-full block">
                            <div class="flex items-center    py-2">
                                ...
                                <div class="pl-3">
                                    ...
                                    <div :class="(dark)?`text-blue-500`:`text-white`" class=" text-sm">
                            ...
                            <div class="w-full mt-2 flex">
                                <span :class="(dark)?`text-blue-500`:`text-white`" class="  text-xs font-medium  ">
                                    <span   class="font-semibold pr-2">Start</span>: Sunday, 23 August
                                </span>
                                <q-space />
                                <span :class="(dark)?`text-yellow-600`:`text-white`" class=" text-xs font-medium  ">3 Programs</span>
                    ...
                    <div class="p-4 mt-4">
                        ...
                        <div >
                            <div class="flex w-full mt-6">
                                ...
                                <q-space />
                                <button :class="(dark)?` bg-grey-10 text-gray-300`:` bg-yellow-500 text-white`" class="rounded-full   px-4 text-gray-300"> <span class="mdi mdi-eye pr-2"></span> View All</button> 
                            </div>

                            <div class="mt-4  ">
                                <div :class="(dark)?` bg-grey-10 `:` bg-or text-white`" class="rounded shadow-xl  w-full m-2 mt-4 p-2 border-l-4 border-green-600" v-for="i in 4" :key="i">
                                        ...
                                        <div class="pl-3">
                                            ...
                                            <div class="w-full mt-2 flex">
                                                <span class="text-blue-600 text-xs font-medium  ">
                                                    <span class="font-semibold">End</span>: Sunday, 23 August
                                                </span>
