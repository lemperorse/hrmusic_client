<template>
<q-page class="">
    <div class="bg-black h-screen flex flex-col items-end">
        <div class="w-screen flex-1   mr-4  bg-black shadow-xl  relative overflow-hidden">
            <div class=" h-96  absolute w-full z-0"></div>
            <div class="flex flex-col overflow-y-auto h-full p-4 space-y-4">
                <div class="flex w-full">
                    <q-btn class="flex text-white">
                ...
                <div class="flex flex-col z-10 ml-4 text-white pt-2">

                    <div class="text-xl mb-2"><span class="text-yellow-600 font-semibold">Hello</span>, Pongvarid </div>
                    <div class="w-full   flex">
                        <span class="text-gray-200  text-3xl">Recend</span>
                        <q-space />
                        <q-btn  color="grey-9" size="sm" rounded  @click="$router.push('/app/goal')" >
                            <i class="em em-first_place_medal" aria-role="presentation" aria-label="FIRST PLACE MEDAL"></i>
                            <span class="pl-2">New Goal</span>
                        </q-btn>
                    </div>
                </div>
                <div class="   z-10 shadow-md text-sm">

                    <div class="shadow-dark rounded-xl w-full md:w-96 p-4 bg-c-c relative overflow-hidden">
                        <a href="#" class="w-full h-full block">
                            ...
                            <div class="w-full mt-2 flex"> 
                                <span class="text-blue-600 text-xs font-medium  ">
                                    <span class="font-semibold">Start</span>: Sunday, 23 August
                                </span>
                                <q-space />
                                <span class="text-yellow-600 text-xs font-medium  " >3 Programs</span>
